...
rm -R ~/cortes/.venv
cortes-builder update && cortes-builder install CortesDiskMonitor
...
cortes-builder install resulthost==1.3.7-beta webstreamhost smartmicrohost webui cameraautomatcs roadar roadarsdk accounthost --force
